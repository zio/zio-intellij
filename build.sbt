...
lazy val scalaPluginVersion = "2022.2.17"
lazy val pluginVersion      = "2022.2.20" + sys.env.get("ZIO_INTELLIJ_BUILD_NUMBER").fold(".0")(v => s".$v")

ThisBuild / intellijPluginName := "zio-intellij"
ThisBuild / intellijBuild := "2022.2.3"
