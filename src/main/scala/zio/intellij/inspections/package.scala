...
package object inspections {
  ...
  object zioMethods {
    ...
    val `.foldZIO`: Qualified              = invocation("foldZIO").from(zioLikePackages)
    ...
    val `.foldCauseZIO`: Qualified         = invocation("foldCauseZIO").from(zioLikePackages)
    val `.foldTraceM`: Qualified           = invocation("foldTraceM").from(zioLikePackages)
    val `.foldTraceZIO`: Qualified         = invocation("foldTraceZIO").from(zioLikePackages)
