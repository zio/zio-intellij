...
object TypeAnnotationSettings {
  ...
  def set(project: Project, newSettings: ScalaCodeStyleSettings): Unit ={
    ...
    TYPE_ANNOTATION_EXCLUDE_WHEN_TYPE_IS_STABLE = newSettings.TYPE_ANNOTATION_EXCLUDE_WHEN_TYPE_IS_STABLE
    TYPE_ANNOTATION_EXCLUDE_IN_TEST_SOURCES = newSettings.TYPE_ANNOTATION_EXCLUDE_IN_TEST_SOURCES
    TYPE_ANNOTATION_EXCLUDE_IN_DIALECT_SOURCES = newSettings.TYPE_ANNOTATION_EXCLUDE_IN_DIALECT_SOURCES
