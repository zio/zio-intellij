...
/**
 *  Base matcher for using with [[org.junit.Assert.assertThat]] or [[org.junit.Assume.assumeThat]]. Please use extending
 *  of this class instead of [[org.hamcrest.BaseMatcher]].
 *
 *  @tparam V
 *    type of the actual and expected value
 */
